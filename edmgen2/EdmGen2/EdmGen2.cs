...
namespace EdmGen2
{
    ...
    public class EdmGen2
    {
        ...
        protected enum Mode { FromEdmx, ToEdmx, ModelGen, CodeGen, ViewGen, Validate, RetrofitModel, Help }

        // a class that understands what the different XML namespaces are for the different EF versions. 
        protected static NamespaceManager _namespaceManager = new NamespaceManager();
        ...
        protected static void FromEdmx(string[] args)
        {
            FileInfo edmxFile;
        ...
        protected static void FromEdmx(FileInfo edmxFile)
        {
        ...
        protected static void PrintModelGenUsage()
        {
        ...
        protected static void ModelGen(string[] args)
        {
        ...
        protected static void ModelGen(
        ...
        protected static void RetrofitModel(string[] args)
        {
            if (args.Length < 4 || args.Length > 5)
            {
                ShowUsage();
        ...
        protected static void CodeGen(string[] args)
        {
            if (args.Length != 3)
            {
                ShowUsage();
        ...
        protected static void CodeGen(FileInfo edmxFile, LanguageOption languageOption)
        {
            XDocument xdoc = XDocument.Load(edmxFile.FullName);
        ...
        protected static void Validate(string[] args)
        {
            FileInfo edmxFile = null;
            if (ParseEdmxFileArguments(args[1], out edmxFile))
            {
        ...
        protected static void ViewGen(string[] args)
        {
            FileInfo edmxFile = null;
        ...
        protected static void ValidateAndGenerateViews(FileInfo edmxFile, LanguageOption languageOption, bool generateViews)
        {
        ...
        protected static void ToEdmx(string[] args)
        {
        ...
        protected static void ToEdmx(FileInfo cFile, FileInfo sFile, FileInfo mFile)
        {
        ...
        protected static void ToEdmx(String c, String s, String m, FileInfo edmxFile)
        {
        ...
        protected static XElement GetCsdlFromEdmx(XDocument xdoc)
        {
        ...
        protected static XElement GetSsdlFromEdmx(XDocument xdoc)
        {
            Version version = _namespaceManager.GetVersionFromEDMXDocument(xdoc);
        ...
        protected static XElement GetMslFromEdmx(XDocument xdoc)
        {
            Version version = _namespaceManager.GetVersionFromEDMXDocument(xdoc);
        ...
        protected static bool ParseEdmxFileArguments(
        ...
        protected static bool ParseCMSFileArguments(
        ...
        protected static Mode GetMode(string arg)
        {
        ...
        protected static bool ParseLanguageOption(string arg, out LanguageOption langOption)
        {
        ...
        protected static string GetFileNameWithNewExtension(
        ...
        protected static void WriteErrors(IEnumerable<EdmSchemaError> errors)
        {
            if (errors != null)
            {
        ...
        protected static void WriteError(EdmSchemaError e)
        {
            if (e.Severity == EdmSchemaErrorSeverity.Error)
            {
                Console.Write("Error:  ");
        ...
        protected static string GetFileExtensionForLanguageOption(
        ...
        //
        protected static void FixUpMslForEDMDesigner(XElement mappingRoot)
        {
        ...
        protected static void FixUpEntitySetMapping(
        ...
        protected static void FixUpEntityTypeMapping(
        ...
        protected static void ReparentChildren(
    ...
    public class NamespaceManager
    {
        ...
        public Version GetVersionFromEDMXDocument(XDocument xdoc)
        {
        ...
        public Version GetVersionFromCSDLDocument(XDocument xdoc)
        {
            XElement el = xdoc.Root;
        ...
        public XNamespace GetMSLNamespaceForVersion(Version v)
        {
            XNamespace n;
        ...
        public XNamespace GetCSDLNamespaceForVersion(Version v)
        {
            XNamespace n;
        ...
        public XNamespace GetSSDLNamespaceForVersion(Version v)
        {
            XNamespace n;
        ...
        public XNamespace GetEDMXNamespaceForVersion(Version v)
        {
            XNamespace n;
        ...
        public Version GetVersionForNamespace(XNamespace n)
        {
            Version v;
